...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  ...
  <body class="min-h-screen flex flex-col bg-gradient-to-r from-[#008D99] to-[#b2e6eb]">
        ...
        <div>
          ...
          <div class="flex flex-col gap-3 text-sm">
            <div class="flex items-center gap-2">
              ...
              <span>(505) 2278-3800 ext. 5424</span>
            </div>
            <div class="flex items-center gap-2">
              <!-- Icono WhatsApp -->
